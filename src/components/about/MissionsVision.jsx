...
const MissionsVision = () => {
    ...
    const motionPropsRight = mounted
        ? {
              initial: 'hidden',
              whileInView: 'visible',
              viewport: { once: true },
            ...
            <section className="relative py-24 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] overflow-hidden">
                ...
                <div className="container text-center mb-16 relative z-10">
                    ...
                    <p className="text-gray-700 mt-4 max-w-2xl mx-auto">
                        At <span className="text-codedrift-pink font-semibold">Code Drift</span>, we
                        empower individuals through expert-led, hands-on training to excel in the
                        tech industry.
                    </p>
                </div>
                    ...
                    <div className="relative grid md:grid-cols-2 gap-10 px-4 z-10">
                        ...
                        <motion.div
                            ...
                            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 h-full relative z-[2]">
                                ...
                                <p className="text-gray-600">
                                    Whether you’re starting or advancing your career, we help you
                        ...
                        <motion.div
                            ...
                            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 h-full relative z-[2]">
                                ...
                                <p className="text-gray-600">
                                    Staying updated with the latest industry trends, we prepare
