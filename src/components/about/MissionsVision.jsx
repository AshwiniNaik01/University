    ...
    <section className="relative py-24 bg-gradient-to-br from-[#fdfbfb] to-[#ebedee] overflow-hidden">
        ...
        <div className="container text-center mb-16 relative z-10">
            ...
            <p className="text-gray-700 mt-4 max-w-2xl mx-auto">
                At <span className="text-codedrift-pink font-semibold">Code Drift</span>, we empower individuals
                through expert-led, hands-on training to excel in the tech industry.
            </p>
        </div>
                ...
                >
                    ...
                    <div className="bg-white/80 backdrop-blur-md rounded-2xl p-8 h-full relative z-[2]">
                        ...
                        <p className="text-gray-700 leading-relaxed mb-3">
                            ...
                            accessible to all, building a diverse and inclusive tech community.
                        </p>
                        <p className="text-gray-600">
