  ...
  const steps = [
    {
      ...
      duration: "1-2 Days",
      details: ["Online registration form", "Email verification", "Profile setup"]
    },
    {
      id: 2,
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16">
          {/* <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-50 to-blue-100 rounded-full px-6 py-3 mb-4">
            ...
            <span className="font-semibold text-blue-700">ADMISSION PROCESS</span>
          </div> */}
          
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Your Journey to <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Success</span>
          </h2>
          
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A simple 5-step process from registration to certification. Follow our guided path to 
            academic excellence at SGBAU.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 right-0 top-1/2 transform -translate-y-1/2 h-2 bg-gradient-to-r from-blue-200 via-purple-200 to-red-200 rounded-full hidden lg:block">
            <div className="h-2 bg-gradient-to-r from-blue-500 via-purple-500 to-red-500 rounded-full transition-all duration-1000"
          ...
          <div className="absolute left-0 right-0 top-1/2 transform -translate-y-1/2 flex justify-between px-4 lg:hidden">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="w-3 h-3 bg-gray-300 rounded-full relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-4 relative z-10">
            {steps.map((step, index) => (
              <MotionDiv
                ...
                className={`relative cursor-pointer ${step.bgColor} ${step.borderColor} border-2 rounded-2xl p-6 transition-all duration-300 ${
                  activeStep === index ? 'ring-4 ring-opacity-30 ring-current transform scale-105 shadow-2xl' : 'shadow-lg hover:shadow-xl'
                }`}
              >
                {/* Step Number Badge */}
                <div className={`absolute -top-4 left-1/2 transform -translate-x-1/2 w-10 h-10 rounded-full bg-gradient-to-r ${step.color} text-white font-bold text-lg flex items-center justify-center shadow-lg border-4 border-white`}>
                  {step.id}
                </div>
                ...
                <div className="text-center">
                  ...
                  {/* Duration */}
                  {/* <div className="inline-flex items-center gap-2 bg-white px-3 py-1.5 rounded-full text-sm font-medium text-gray-700 mb-4">
                ...
                {/* {activeStep === index && (
                  <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2">
                    <div className="w-6 h-6 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center animate-bounce">
                      <FaChevronRight className="text-white text-xs rotate-90" />
                    </div>
                  </div>
                )} */}
              </MotionDiv>
