    ...
    const courses = [
        {
            ...
            desc: "Master HTML, CSS, JavaScript, React, Node.js, MongoDB & more through hands-on projects.",
            icon: <Code className="w-6 h-6 text-codedrift-pink" />,
            link: "#fullstack",
        },
        {
            title: "App Development with React Native",
            desc: "Learn to build cross-platform apps for Android & iOS with a single codebase.",
            icon: <Smartphone className="w-6 h-6 text-codedrift-blue" />,
            link: "#reactnative",
        },
        {
            title: "DSA + Competitive Programming",
            desc: "Sharpen your problem-solving skills and ace coding interviews with real contests.",
            icon: <Rocket className="w-6 h-6 text-codedrift-indigo" />,
            link: "#dsa",
        },
    ];
            ...
            <div className="container">
                ...
                <div className="text-center relative z-10">
                    ...
                    <p className="text-lg text-gray-600 mb-16">
                        Programs designed to help you upskill, build real-world projects, and stay ahead in your tech career.
                    </p>
                        ...
                        {courses.map((course, i) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3 mb-3">
                                    {course.icon}
                                    <h3 className="text-lg font-semibold text-codedrift-indigo">{course.title}</h3>
                                </div>
