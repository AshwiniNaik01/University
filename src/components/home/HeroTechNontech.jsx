  ...
  return (
    <section className="relative h-lvh bg-gradient-to-br from-[#fdfbfb] via-[#f7f9fc] to-[#f0f4f8] text-gray-800 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <GraduationCap
          className="absolute top-6 left-6 text-codedrift-pink/20 animate-pulse"
          size={70}
        />
        <BookOpen
          className="absolute top-10 right-10 text-codedrift-blue/20 animate-pulse"
          size={60}
        />
        <FlaskConical
          className="absolute bottom-16 left-12 text-codedrift-indigo/20 animate-bounce"
          size={60}
        />
        <Briefcase
          className="absolute top-1/2 right-1/3 text-codedrift-pink/20 animate-spin-slow"
          size={70}
        />
      </div>
        ...
        <div className="relative h-full z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-center md:text-left font-semibold text-lg md:text-xl text-gray-600 mb-4">
              Explore Technical & Non-Technical degree programs designed to
              build knowledge, skills, and successful careers.
            </p>
            ...
            <div className="rounded-xl shadow-xl border border-gray-200 overflow-hidden w-full h-[22rem] md:h-[65vh] bg-white animate-[float_6s_ease-in-out_infinite]">
              ...
              <div className="p-4 font-mono text-sm bg-[#1e1f29] text-white rounded-b-xl h-full">
                <pre className="overflow-y-auto h-full whitespace-pre-wrap">
                  <Typewriter
                    words={[ugCourses, pgCourses, diplomaCourses, phdCourses]}
                    loop={true}
                    typeSpeed={30}
                    deleteSpeed={10}
                    delaySpeed={3000}
