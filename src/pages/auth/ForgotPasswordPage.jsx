 ...
 *
 * Displays a simple password recovery form where users can enter their
 * registered email or phone number to receive a reset link or OTP.
 */
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-10">
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-6 sm:p-8 border border-gray-200">
        ...
        <div className="text-center text-sm mt-6 text-gray-600">
          ...
          <Link
            to="/login"
            className="text-codedrift-indigo font-medium hover:underline"
          >
            Back to Login
          </Link>
        </div>
