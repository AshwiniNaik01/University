...
// import { Code, Laptop, Database, Layers, Cpu, Terminal, GraduationCap, Calendar, Video, Palette, Server, ArrowRight, MoveRight, MoveDown, ChevronDown } from "lucide-react";
// import { courseList } from "../../data/coursesList";
// import { Link, useLocation } from "react-router-dom";
// import Image from "../../components/utility/Image";
// import { coursesBackendImage, coursesFrontendImage, coursesUiUxImage } from "../../access-assets/images";
// import { coursesBgVideo } from "../../access-assets/videos";
// import { Button } from "../../components/utility/Button";
// import useScrollToHash from "../../hooks/useScrollToHash";
// import { getAllCourses } from "./courses";
// // import { Calendar, GraduationCap, Laptop } from "lucide-react";
...
//                                 "Enrolling in our courses can lead to tangible career advantages, including
//                                 expanded job opportunities and increased chances for promotions."
//                             </p>
//                         </div>
...
//             {/* ✅ Front End Section */}
//             <section id='courses-start' className="relative py-20 bg-white overflow-hidden">
...
//                                 At{" "}
//                                 <span className="text-codedrift-pink font-semibold">Code Drift</span>, we offer
//                                 comprehensive training in essential web development technologies including{" "}
//                                 <strong>HTML</strong>, <strong>CSS</strong>, <strong>JavaScript</strong>, and
//                                 modern frameworks like <strong>React</strong>, <strong>Angular</strong>, and
//                                 <strong> Vue</strong>. Learn to build responsive websites, dynamic user
...
//                             Learn backend technologies like <strong>Node.js with Express</strong>,{" "}
//                             <strong>PHP with Laravel</strong>, <strong>Python with Django</strong>, and{" "}
//                             <strong>Java with Spring Boot</strong>. Gain hands-on experience in building
//                             robust APIs, managing databases, and creating secure, scalable applications.
//                         </p>
//                     </div>
//                 </div>
//             </section>
...
//                         </div>
//                         <p className="text-gray-700 leading-relaxed mb-6">
//                             Master UI/UX tools like <strong>Figma</strong>, <strong>Adobe XD</strong>,{" "}
//                             <strong>Photoshop</strong>, and <strong>Illustrator</strong>. Create stunning,
//                             user-friendly digital experiences with expert guidance and real-world design
//                             principles.
//                         </p>
...
//       <section id='courses-list' className="relative py-20 bg-gradient-to-r from-[#fdfbfb] to-[#ebedee] overflow-hidden">
...
//                                         {/* <div className="w-12 h-12 flex items-center justify-center rounded-full shadow-inner mr-3 bg-codedrift-pink/10">
//                                             <img
