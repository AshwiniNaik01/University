...
const MentorPage = () => {
    ...
    //                 email: data.email,
    //                 phone: data.mobileNo,
    //                 rating: 4.9, // hardcoded unless returned in API
    //                 reviews: 352, // hardcoded unless returned in API
    //                 summary: data.summary,
    //                 certifications: data.certifications || [],
    //                 achievements: data.achievements || [],
    //                 courses: data.courses.map((c) => c.title) || [], // assuming course objects in array
    //                 testimonials: [] // If available in backend later
    //             };
